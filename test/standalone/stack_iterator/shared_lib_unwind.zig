...
pub fn main() !void {
    ...
    if (builtin.omit_frame_pointer and comptime builtin.os.tag.isDarwin() and builtin.cpu.arch == .aarch64) return;
    if (builtin.os.tag.isDarwin() and builtin.cpu.arch == .x86_64) return; // https://github.com/ziglang/zig/issues/21337
