...
pub const Stat = switch (native_os) {
    .linux => switch (native_arch) {
        ...
        .mips, .mipsel => if (builtin.abi.isMusl()) extern struct {
            dev: dev_t,
            __pad0: [2]i32,
            ino: ino_t,
            mode: mode_t,
        ...
        .mips64, .mips64el => if (builtin.abi.isMusl()) extern struct {
            dev: dev_t,
            __pad0: [3]i32,
            ino: ino_t,
            mode: mode_t,
...
pub const getcontext = if (builtin.abi.isAndroid() or builtin.os.tag == .openbsd)
{} // android bionic and openbsd libc does not implement getcontext
else if (native_os == .linux and builtin.abi.isMusl())
    linux.getcontext
else
    private.getcontext;
